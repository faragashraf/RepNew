    ...
    Protected Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        ...
        If GetTbl("Select GetDate() as Now_", TimeTble) = Nothing Then
            If TimeTble.Rows.Count > 0 Then
                ...
                If GetTbl("SELECT UsrId,UsrNm,UsrCat,UsrRealNmEn,UsrBarcode,UaccSTime,Posstion,ReportingTo FROM Int_access INNER JOIN Int_user ON UsrId = Int_access.UaccUsrID 
inner join (SELECT IntUserCat.UCatId, IntUserCat.UCatNmEn AS Posstion, IntUserCat_2.UCatNmEn AS ReportingTo
                    ...
                    If AcssTble.Rows.Count > 0 Then
                        ...
                        Label2.Text = "Your Already Registered Today On " & Format(AcssTble.Rows(0).Item("UaccSTime"), "H:mm")
                    ...
                    Else
                        UsrTbl.Rows.Clear()
                        If GetTbl("select UsrId,UsrNm,UsrCat,UsrRealNmEn,Poss.Posstion,Poss.ReportingTo,UsrBarcode from int_user inner join 
                            ...
                            If UsrTbl.Rows.Count > 0 Then
                                If CDate(Format(Time_, "HH:mm:ss")) <= #11:59:59 AM# Then
                                    ...
                                    Label2.Text = "Good Morning : " & UsrTbl.Rows(0).Item("UsrRealNmEn").ToString
                                Else
                                    'Label2.Text = Format(CDate(Time_), "H:mm:ss").ToString & "t"
                                    Label2.Text = "Good Evening : " & UsrTbl.Rows(0).Item("UsrRealNmEn").ToString
                                End If
                                Label2.ForeColor = Color.Green
