    ...
    Private Sub SubmtTick()
        ...
        Try
            If Def.CONSQL.State = ConnectionState.Closed Then
                Def.CONSQL.Open()
            End If
            sqlComminsert_1.Connection = Def.CONSQL
            sqlComminsert_2.Connection = Def.CONSQL            'insert Update into Update Table
    ...
    Private Sub InsUpdtSub(StrWhere As Integer, Knd As ComboBox, Txt As TextBox, LblNm As Label)
        ...
        If Knd.SelectedIndex > -1 Then
            If Txt.TextLength > 0 Then
                TreeView1.Visible = True
                If Fn.InsUpdate("insert into TkEvent (TkupTkSql, TkupTxt, TkupEvtId, TkupUserIP, TkupUser) VALUES ('" & StrWhere & "','" & Txt.Text & "','" & Knd.SelectedValue & "','" & OsIP() & "','" & Usr.PUsrID & "')", "1018&H") = Nothing Then
